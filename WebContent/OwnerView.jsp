...
<body style="margin:0 auto;width:1000px">
	...
	<div class="container">
		...
		<div class="head-wl d-md-flex py-3">
			<!-- <div class="headder-w3 text-uppercase p-1 text-center">
				<h1><a href="index.html">CHARON</a></h1>
			</div> -->
    ...
    %>
   <center><h2 style="padding-top:30px;font-family:Trebuchet MS, Helvetica, sans-serif;font-weight: bold;">UPLOAD STATUS</h2></center>
	<table id="customers">
       <thead>  
          <tr> 
            <th>FILE ID</th>
	...
	%>
	  <tbody>
	     <tr> 
            ...
            <td><textarea rows="5" cols="40" readonly><%=rs.getString("ENC")%> </textarea></td>
           <td> <%=rs.getString("STATUS")%> </td>
          <td>
          <a href="ownerview1.jsp?id=<%=rs.getString("FID")%>" style="color:red;font-weight:bold;text-decoration:underline;font-size:20px;">UPLOAD</a><br>or<br>
          <a href="ownerview2.jsp?id=<%=rs.getString("FID")%>" style="color:red;font-weight:bold;text-decoration:underline;font-size:20px;">CANCEL</a>
          </td>
          </tr>
