...
<body style="margin:0 auto;width:1000px">
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-faded">
		  ...
		  <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
			<ul class="navbar-nav">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="OwnerView.jsp">VIEW FILE DETAILS</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" href="#">USER REQUESTS</a>
			  </li>
			  <li class="nav-item">
	...
	<!-- <form method="post" action="uploaddb.jsp" enctype="multipart/form-data">
		<table><tr><th>
		<tr><th>FILE ID</th><td><input type="text" name="fileid"></td></tr>
		<tr><th>NAME</th><td><input type="text" name="fname"></td></tr>
		<tr><th>KEY</th><td><input type="text" name="fkey"></td></tr>
		<tr><th>FILE</th><td><input type="file" name="image" id="filetoRead"></td></tr>
		<tr><th><button class="button">ENCRYPT</button></th></tr>
	...
	String dkey = request.getParameter("fkey");
	String filec="";
	Statement st = null;
	ResultSet rs = null;
	ResultSet rs1 = null;
	...
	try
				...
				String qry =" select  * from filerequest where USERNAME = '" + email +"' and FILENAME='"+filename+"'"; 
		rs = st.executeQuery(qry);
		while(rs.next())
		{
			String key1 = rs.getString("FKEY");
			String filen1 = rs.getString("FILENAME");
			if(dkey.equals(key1) && filename.equals(filen1))
			{
				String qry2 =" select  * from upload where FSEARCHNAME='"+ filename +"'"; 
				st.addBatch(qry2);
				//rs1 = st.executeQuery(qry2);
				if(rs.next())
				{
					 filec = rs.getString("FILE");
					
				}
			}
			else
			{
				 filec = "Your Key is Incorrect";
				 dkey = "Incorrect Decryption key";
			}
		}
    ...
    %>
    <form method="post" action="readEncfile1.jsp">
	<table id="customers">
       <thead>  
          <tr> 
           	 <th>FILE ID</th>
	  ...
	  <tbody>
	     <tr > 
            ...
            <td><input type="text" name="fname" value=<%= filename%>></td>
             <td> <input type="text" name="fkey" value=<%=dkey %>></td>
             <td><textarea rows="5" cols="40" value=<%=filec %>></textarea>
