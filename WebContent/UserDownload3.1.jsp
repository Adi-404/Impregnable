...
<body style="margin:0 auto;width:1000px">
	...
	String dkey = (String)session.getAttribute("dkey");
	...
	try
	{
		...
		ResultSet rs = st.executeQuery("SELECT * FROM upload WHERE FID='"+fid+"' AND FILEKEY='"+dkey+"'");
		if(rs.next())
		{
			%>
			
			<table id="customers" style="margin-left:60px;margin-top:100px;">
			<tr><th>FILE ID</th><td><input type="text" name="fid" required="" readonly value=<%=fid %>></td></tr>
			<tr><th>DATA</th><td><textarea rows="10" cols="60" readonly><%=rs.getString("FILE") %></textarea></td></tr>
			<tr><th></th><td><a class="button" href="Download.jsp">Download</a></td></tr>
			</table>
			<%
		}
	}	
