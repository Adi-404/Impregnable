...
<body style="margin:0 auto;width:1000px">
	...
	<!-- //Navigation -->
	   <center><h2 style="padding-top:30px;font-family:Trebuchet MS, Helvetica, sans-serif;font-weight: bold;">KEY REQUESTS</h2></center>
	<table id="customers">
    <thead>  
       <tr> 
          <th>S.NO</th>
   ...
   String qry =" select  * from filerequest where USERNAME= '" + email +"'"; 
