...
<body style="margin:0 auto;width:1000px">
   ...
   <center><h2 style="padding-top:30px;font-family:Trebuchet MS, Helvetica, sans-serif;font-weight: bold;">FILE REQUESTS</h2></center>
	<table id="customers">
       <thead>  
          <tr> 
            <th>FILE ID</th>
...
String OID = (String)session.getAttribute("3");
/* int id=0; */
String rr = "pending";
...
try
	...
	String qry =" select  * from filerequest where OWNEREMAIL = '" + OID +"'"; 
	...
	%>
	  <tbody>
	     <tr> 
             ...
             <td> <%=rs.getString("REQFOR")%> </td>
             <td> <%=rs.getString("DATE")%> </td>
             <td> <%=rs.getString("STATUS")%> </td>           
             <td><a href="Keysend.jsp?id=<%=FILEID%>&&uemail=<%=rs.getString("USERNAME") %>" style="color:red;font-weight:bold;text-decoration:underline;font-size:20px;">SEND KEY</a>
         </tr>
